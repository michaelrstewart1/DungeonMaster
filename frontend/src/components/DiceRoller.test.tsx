...
describe('DiceRoller', () => {
  ...
  it('renders dice buttons for standard D&D dice', () => {
    ...
    expect(screen.getByRole('button', { name: /d4/i })).toBeTruthy()
    expect(screen.getByRole('button', { name: /d6/i })).toBeTruthy()
    expect(screen.getByRole('button', { name: /d8/i })).toBeTruthy()
    expect(screen.getByRole('button', { name: /d10/i })).toBeTruthy()
    expect(screen.getByRole('button', { name: /d12/i })).toBeTruthy()
    expect(screen.getByRole('button', { name: /d20/i })).toBeTruthy()
  })
